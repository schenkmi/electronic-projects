...
byte ak4497L =0x15; //Lch DAC addr
byte ak4497R =0x16; //Rch DAC addr
...
void setup() {
  ...
  //DEBUG_SERIAL.println("OLED begun");
  display.display();
   //delay(500);
...
{ 
 ...
 // display.clearDisplay();
  ...
  display.print(ReadRegister(ak4118, 0x03),BIN);
  //display.print("connected!");
  //display.println("IP: 10.0.1.23");
  display.setCursor(0,10);
  display.print(ReadRegister(ak4118, 0x06),BIN);
  display.setCursor(0,20);
  display.print(ReadRegister(ak4118, 0x07),BIN);
  display.setCursor(0,0);
