...
/**
 * Output format see page 48
 */
enum AK4137OutputFormat {
    AK_LSB = 1, /* Right justified (LSB justified) */
    AK_I2S = 2, /* I2S format */
    AK_MSB = 3, /* Left justified (MSB justified) */
};

/**
 * Output world length enum see page 48
 */
...
typedef struct {
    ...
    enum AK4137OutputFormat output_format;
